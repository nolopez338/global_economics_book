...
\begin{document}
	...
	\begin{verbatim}
		Decision node choose strategy
		│
		├─ Strategy A  Innovate
		│   ├─ High demand 0.30 → 150k
		│   ├─ Moderate demand 0.40 → 80k
		│   └─ Low demand 0.30 → −20k
		│
		├─ Strategy B  Improve
		│   ├─ High demand 0.30 → 110k
		│   ├─ Moderate demand 0.40 → 90k
		│   └─ Low demand 0.30 → 40k
		│
		└─ Strategy C  License
		├─ High demand 0.30 → 70k
		├─ Moderate demand 0.40 → 70k
		└─ Low demand 0.30 → 60k
	\end{verbatim}
