\section{Example 2}\label{sec:example2}
	...
	\subsection{(C2) Interpreting the parts of the decision problem}\label{subsubsec:example2-c2}
	...
	\subsection{(C3) Building the payoff table from revenue and expense information}\label{subsubsec:example2-c3}
	...
	\subsection{(C4) Maximax rule for decision making without probabilities}\label{subsubsec:example2-c4}
	...
	\subsection{(C5) Maximin rule for decision making without probabilities}\label{subsubsec:example2-c5}
	...
	\subsection{(C6) Maximum opportunity criterion (minimax regret)}\label{subsubsec:example2-c6}
	...
	\subsection{(C7) Using probabilities and expected value (Bayes decision rule)}\label{subsubsec:example2-c7}
	...
	\subsection{(C9) Tree diagram of the decision-making problem}\label{subsubsec:example2-c9}
	...
	\begin{center}
		\begin{tikzpicture}[
			...
			\node {Decision node (choose strategy)}
				child { node {Strategy A EU avocado plant}
				...
				child { node {Strategy B US coffee focus}
				...
				child { node {Strategy C regional diversification}
	...
	\subsection{(C8) Comparing Bayes, Maximin, Maximax and minimax regret}\label{subsubsec:example2-c8}
	...
	\subsection{(C10) Evaluating all possibilities in the decision problem}\label{subsubsec:example2-c10}
	...
	\subsection{(C1) Formulating the final decision and summarising all criteria}\label{subsubsec:example2-c1}
