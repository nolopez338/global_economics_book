\section{Grade 10: Analysis of Decisions}\label{sec:grade10-term2-overview}

\subsection{Learning Strand}\label{sec:grade10-term2-strand}

Complex and non-standard problems solving.

\subsection{Learning Objective}\label{sec:grade10-term2-objective}

Evaluate all possibilities in a decision-making problem using different strategies.

\subsection{Assessment Criteria}\label{sec:grade10-term2-criteria}
