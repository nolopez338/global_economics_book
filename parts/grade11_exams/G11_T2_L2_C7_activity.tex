...
\begin{document}
	...
	\begin{tabular}{|Y|Z|}
		...
		{\footnotesize
			...
			C7 is assessed in every problem. At least 6 problems must be solved correctly in order to pass Criterion C7.\par
		}
		\\
		\hline
	\end{tabular}
	...
	\begin{multicols}{2}
		...
		Criterion C7 is assessed in every problem. A criterion is considered passed when it is correctly activated in at least six of the seven problems.
