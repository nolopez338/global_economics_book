...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\begin{enumerate}
			...
			\item Use a dashboard toggle or side-by-side view for t vs z values, including explicit visualization of both intervals (comparison table, interval bars, or dual error bars on the same mean marker).
		...
		The dashboard shows $CI_t$ and $CI_z$ side-by-side for the Base week using a shared mean marker with two interval bars and a comparison field for $ME_t-ME_z$. This view justifies the t-based conclusion while making the z approximation directly visible.
		...
		\textbf{Dashboard justification}\par
		The dashboard presents a side-by-side t-vs-z comparison for Port A -- Q2 with both intervals visualized and a displayed $ME_t-ME_z$ field. This evidence supports the final t-based conclusion and shows that the z approximation is consistent for this sample size.
