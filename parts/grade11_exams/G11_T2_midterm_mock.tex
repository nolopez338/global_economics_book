...
\begin{document}
	...
	\begin{multicols}{2}
		...
		Criteria C1 through C7 are evaluated across the full mock midterm.

		\vspace{0.25cm}
		\SubsectionBox{1. Metropolitan Transit Fare Study}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{2. University Dining Checkout Times}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{3. Utility Reimbursement Proportions}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{4. Municipal Invoice Monitoring}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{5. Cooperative Loan Size Comparison}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{6. Mobile Savings Platform Adoption}\vspace{-0.25cm}
