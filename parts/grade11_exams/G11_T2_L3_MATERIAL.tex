...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\[
		11.8,\ 12.4,\ 13.1,\ 12.7,\ 11.9,\ 13.5,\ 12.2,\ 12.9,\ 13.3,\ 12.0,\ 12.6,\ 13.0,\ 12.8,\ 11.7,\ 13.4,\ 12.5
		\]
		...
		\]
		\[
		\bar{x}=\frac{\sum x_i}{n}=\frac{201.8}{16}=12.6125
		\]
		\[
		s^2=\frac{\sum (x_i-\bar{x})^2}{n-1}=0.3332,\qquad s=\sqrt{0.3332}=0.5772
		\]
		...
		\[
		SE=\frac{s}{\sqrt{n}}=\frac{0.5772}{\sqrt{16}}=0.1443
		\]
		Step 4 -- Margin of error
		\[
		E=t^*\cdot SE=2.131(0.1443)=0.3075
		\]
		Step 5 -- Confidence interval
		\[
		\mu\in \bar{x}\pm E=12.6125\pm 0.3075=[12.3050,\,12.9200]
		\]
		Step 6 -- Interpretation
		With 95\% confidence, the bank's mean daily net fee revenue from this package is between 12.305 and 12.920 thousand USD.
		...
		\begin{itemize}
			...
			\[
			2.8,\ 3.1,\ 2.9,\ 3.3,\ 3.0,\ 2.7,\ 3.2,\ 3.4
			\]
		...
		\]
		\[
		\sum x_{\text{raw}}=24.4,\qquad
		\sum x_{\text{grouped}}\approx 3(2.6)+5(3.0)+4(3.4)=36.4
		\]
		\[
		\bar{x}=\frac{24.4+36.4}{20}=3.04\text{ hours}
		\]
		\[
		s^2\approx\frac{\sum (x_i-\bar{x})^2}{n-1}=0.0804,\qquad s\approx\sqrt{0.0804}=0.2836\text{ hours}
		\]
		Step 2 -- Degrees of freedom and critical value
		\[
		...
		Step 3 -- Standard error
		\[
		SE=\frac{s}{\sqrt{n}}=\frac{0.2836}{\sqrt{20}}\approx 0.0634
		\]
		Step 4 -- Margin of error
		\[
		E=t^*\cdot SE=1.729(0.0634)\approx 0.1096
		\]
		Step 5 -- Confidence interval
		\[
		\mu\in 3.04\pm 0.1096=[2.930,\,3.150]\text{ hours}
		\]
		Step 6 -- Interpretation
		With 90\% confidence, the mean ticket-resolution time is between 2.930 and 3.150 hours.
		Step 7 -- Conclusion about the parameter
		The claim $\mu=3.10$ hours is plausible because it lies inside the interval.
		But a stronger statement that the process already secures a mean below 3.00 hours is not justified, since 3.00 is also inside the interval and the upper bound is above 3.00.
	\end{ExamProblems}
\end{document}
