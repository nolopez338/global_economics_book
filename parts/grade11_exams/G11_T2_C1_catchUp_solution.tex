...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\textbf{Sample A (Route A, grouped data in USD):}
		\begin{center}
		\begin{tabular}{c c}
		\toprule
		Tip income $x$ & Frequency $f$\\
		\midrule
		6  & 2\\
		10 & 4\\
		14 & 6\\
		...
		\textbf{Sample B (Route B, grouped data in USD):}
		\begin{center}
		\begin{tabular}{c c}
		\toprule
		Tip income $x$ & Frequency $f$\\
		...
		For each sample, compute the sample mean and sample standard deviation using grouped-data formulas. Then compare the two routes in terms of tip-income volatility.
		...
		\subsection*{Problem description}
		A youth investment club compared two independent grouped samples of monthly portfolio returns (USD) from two different micro-investment strategies before deciding how to allocate new capital.

		\textbf{Sample A (Strategy A, grouped intervals in USD):}
		\begin{center}
		\begin{tabular}{c c}
		\toprule
		Interval & Frequency\\
		...
		\textbf{Sample B (Strategy B, grouped intervals in USD):}
		\begin{center}
		\begin{tabular}{c c}
		\toprule
		Interval & Frequency\\
		...
		Using class midpoints, compute the sample mean and sample standard deviation for each strategy. Then compare which strategy appears more stable for conservative student investors.
