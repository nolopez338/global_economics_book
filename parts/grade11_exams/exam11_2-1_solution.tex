...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\]
		\[
		s_A^2 = \frac{17.5}{6-1} = 3.5
		\]
		\[
		s_A = \sqrt{s_A^2} = \sqrt{3.5} \approx 1.87
		\]
		\[
		\sum (x_B-\bar{x}_B)^2 = (24-24.33)^2 + (26-24.33)^2 + (23-24.33)^2 \approx 4.67
		\]
		\[
		s_B^2 = \frac{4.67}{3-1} \approx 2.33
		\]
		\[
		s_B = \sqrt{s_B^2} \approx 1.53
		\]
		...
		\]
		\[
		s^2 = \frac{784.59}{54-1} \approx 14.80
		\]
		\[
		s = \sqrt{s^2} \approx 3.85
		\]
		...
		\]
		\[
		s^2 = \frac{874.55}{55-1} \approx 16.20
		\]
		\[
		s = \sqrt{s^2} \approx 4.02
		\]
