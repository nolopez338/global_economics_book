...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\]
		\[
		\sum f(x-\bar{x})^2 \approx 324.65 + 89.90 + 53.11 + 316.93 = 784.59 \qquad \longrightarrow \qquad s = \sqrt{\frac{\sum f(x-\bar{x})^2}{n-1}}  = \sqrt{\frac{784.59}{54-1}} \approx 3.85
		\]
		...
		\]
		\[
		\sum f(x-\bar{x})^2 \approx 874.55 \qquad \longrightarrow \qquad s = \sqrt{\frac{\sum f(x-\bar{x})^2}{n-1}} \qquad \longrightarrow \qquad s = \sqrt{\frac{874.55}{55-1}} \approx 4.02
		\]
