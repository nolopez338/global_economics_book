...
\begin{document}
	...
	\begin{multicols}{2}
		...
		Each assessment criterion is evaluated across the seven problems. A criterion is considered passed when it is correctly activated in at least two of the seven problems.
