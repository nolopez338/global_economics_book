...
\begin{document}
	...
	\begin{tabular}{|Y|Z|}
		...
		{\footnotesize
			...
			C5: Construct a 95\% confidence interval using known population standard deviation.\par
			C4: Interpret the meaning of a 95\% confidence interval in context.\par
		}
		\\
		\hline
	\end{tabular}
