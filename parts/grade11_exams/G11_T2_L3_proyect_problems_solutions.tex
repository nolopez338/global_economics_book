...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\mu\in[39.15,\,42.85]
		\]
		Interpretation: With 95\% confidence, the branch's mean daily disbursement is between 39.15 and 42.85 hundred USD.
		...
		\mu\in[1.955,\,2.167]
		\]
		Interpretation: With 90\% confidence, the firm's mean transaction fee is between 1.955 and 2.167 USD.
		...
		123,\ 120,\ 125,\ 129,\ 116,\ 127,\ 122,\ 118,\ 124,\ 121,
		...
		\mu\in[120.46,\,124.54]
		\]
		Interpretation: With 99\% confidence, the chain's mean weekday-morning basket value is between 120.46 and 124.54 USD.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean delivery time},\quad n=\sum f_i=60,\quad \sum f_im_i=2100,\quad \sum f_im_i^2=77910
		\]
		\[
		...
		\mu\in[33.04,\,36.96]
		\]
		Interpretation: With 95\% confidence, mean same-city delivery time is between 33.04 and 36.96 hours.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean daily inventory holding cost},\quad n=120,\quad \sum f_im_i=7870,\quad \sum f_im_i^2=524975
		\]
		\[
		...
		\mu\in[64.43,\,66.74]
		\]
		Interpretation: With 90\% confidence, mean daily holding cost is between 64.43 and 66.74 thousand USD.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean monthly VAT payment},\quad n=250,\quad \sum f_im_i=28810,\quad \sum f_im_i^2=3403450
		\]
		\[
		...
		\mu\in[113.16,\,117.32]
		\]
		Interpretation: With 95\% confidence, mean monthly VAT payment is between 113.16 and 117.32 thousand USD.
		...
		\mu\in[78.09,\,80.15]
		\]
		Interpretation: With 99\% confidence, the bank's mean monthly balance is between 78.09 and 80.15 hundred USD.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean annual claim cost},\quad n=1000,\quad \sum f_im_i=158400,\quad \sum f_im_i^2=25396000
		\]
		\[
		...
		\mu\in[157.44,\,159.36]
		\]
		Interpretation: With 95\% confidence, mean annual claim cost is between 157.44 and 159.36 USD.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean monthly card-processing revenue},\quad n=2500,\quad \sum f_im_i=657000,\quad \sum f_im_i^2=174410000
		\]
		\[
		...
		\mu\in[261.85,\,263.75]
		\]
		Interpretation: With 90\% confidence, mean monthly merchant revenue is between 261.85 and 263.75 thousand USD.
		...
		Step 1 --- C8: Confidence Interval (t-statistic)
		\[
		\mu=\text{population mean quarterly freight billing},\quad n=5000,\quad \sum f_im_i=2631200,\quad \sum f_im_i^2=1401024000
		\]
		\[
		...
		\mu\in[524.21,\,528.27]
		\]
		Interpretation: With 99\% confidence, mean quarterly freight billing is between 524.21 and 528.27 thousand USD.
