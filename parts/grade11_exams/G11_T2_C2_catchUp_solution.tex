...
\begin{document}
	...
	\begin{ExamProblems}
		...
		For Store A (handmade accessories), the long-run daily revenue level in the full records is 275 USD and the overall spread is 50 USD.
		For one reviewed period at Store A, the 95\% confidence interval for average daily revenue runs from 240 USD to 300 USD, and variability is reported as 1600 in (USD)^2.
		For Store B (digital templates), full records are summarized by a long-run typical value of 350 USD and variability of 3600 in (USD)^2.
		For one reviewed period at Store B, the 90\% confidence interval for average daily revenue runs from 330 USD to 390 USD, and the spread is 55 USD.
