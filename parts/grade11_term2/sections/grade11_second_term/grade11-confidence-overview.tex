...
\subsection{Interval Foundations}\label{sec:interval-foundations}
...
\subsection{Conceptual Referents}\label{sec:conceptual-referents-intervals}
...
\subsection{Interval Basics}\label{sec:interval-basics}
