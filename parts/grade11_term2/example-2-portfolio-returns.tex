\section{Example 2}\label{sec:interval-example2}

\subsection{Problem description}\label{subsec:interval-example2-problem}
...
\subsection{(C9) Estimate the mean with a large-sample t approximation}\label{subsubsec:interval-example2-c9}
...
\subsection{(C4) Interpret the confidence interval for a finance decision}\label{subsubsec:interval-example2-c4}
...
\subsection{(C10) Conclude about a statistical parameter in finance and economy}\label{subsubsec:interval-example2-c10}
