\section{Example 2.1}\label{sec:interval-example2-1}

\subsection{Problem description}\label{subsec:interval-example2-1-problem}
...
\subsection{(C7) Compute the sample proportion, standard error, and confidence interval}\label{subsubsec:interval-example2-1-c7}
...
\subsection{(C4) Interpret the interval in economic or financial terms}\label{subsubsec:interval-example2-1-c4}
...
\subsection{(C10) Conclude about a statistical parameter in finance and economy}\label{subsubsec:interval-example2-1-c10}
