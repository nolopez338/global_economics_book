\section{Example 1.2}\label{sec:interval-example1-2}
...
\subsection{(C1) Obtain sample mean and standard deviation}\label{subsubsec:interval-example1-2-c1}
...
\subsection{(C2) Compare sample values to the known true values}\label{subsubsec:interval-example1-2-c2}
...
\subsection{(C3) Explain the need for estimation, based on the comparison}\label{subsubsec:interval-example1-2-c3}
...
\subsection{(C5) Calculate the confidence interval (variance known)}\label{subsubsec:interval-example1-2-c5}
...
\subsection{(C8) Calculate the confidence interval (variance unknown)}\label{subsubsec:interval-example1-2-c8}
...
\subsection{(C4) Interpret the confidence interval in real-life economic or financial terms}\label{subsubsec:interval-example1-2-c4}
...
\subsection{(C10) Conclude about a statistical parameter in finance and economy}\label{subsubsec:interval-example1-2-c10}
