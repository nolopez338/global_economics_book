...
\begin{document}
	...
	\begin{tabular}{|Y|Z|}
		\hline
		{\small
			\textbf{Learning objective:} Understand and apply the maximin criterion to select alternatives in decision-making problems without probabilities.
		}
		&
		{\footnotesize
	...
	\begin{multicols}{2}
		...
		This activity evaluates criterion C5. Read each problem and complete the required decision-analysis tasks.
