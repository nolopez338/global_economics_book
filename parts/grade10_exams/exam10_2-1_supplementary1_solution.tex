...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\item
		\subsection*{Problem description}
		A campus bookstore must choose a stocking plan for a semester. Plan A is premium notebooks, Plan B is standard notebooks, and Plan C is discount notebooks. Demand for notebooks can be strong, moderate, or weak with probabilities $0.35$, $0.45$, and $0.20$. Profit outcomes are given directly: under strong demand Plans A, B, and C earn $3540$, $2800$, and $4500$. Under moderate demand Plans A, B, and C earn $2100$, $2600$, and $3150$. Under weak demand Plans A, B, and C earn $660$, $1200$, and $1800$. Which decision is the risky choice under Maximax, the safe choice under Maximin, and the balanced choice under Expected Value?
		...
		\begin{center}
			\begin{tabular}{l c c c c}
				...
				\midrule
				Strong demand & 0.35 & 3540 & 2800 & 4500 \\
				Moderate demand & 0.45 & 2100 & 2600 & 3150 \\
				Weak demand & 0.20 & 660 & 1200 & 1800 \\
				\bottomrule
		\end{tabular}
		\end{center}
