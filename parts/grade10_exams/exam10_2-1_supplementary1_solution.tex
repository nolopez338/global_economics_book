...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\item
		\subsection*{Problem description}
		A campus bookstore must choose a stocking plan for a semester. Plan A is premium notebooks, Plan B is standard notebooks, and Plan C is discount notebooks. Demand for notebooks can be strong, moderate, or weak with probabilities $0.35$, $0.45$, and $0.20$. Expected unit sales depend on demand and plan. Under strong demand Plan A sells 420 units, Plan B sells 520 units, and Plan C sells 600 units. Under moderate demand Plan A sells 300 units, Plan B sells 380 units, and Plan C sells 450 units. Under weak demand Plan A sells 180 units, Plan B sells 240 units, and Plan C sells 300 units. Unit prices are $22$, $18$, and $15$ for Plans A, B, and C. Total costs by demand and plan are provided in the cost table. Use these parameters to calculate the profit payoff table. Which decision is the risky choice under Maximax, the safe choice under Maximin, and the balanced choice under Expected Value?
		...
		\subsection*{C3}
		Payoff = revenue $-$ cost, where revenue = units $\times$ price and cost is taken from the cost table.
		\begin{center}
		...
		\end{tabular}
		\end{center}
		Total costs by demand and plan are listed below.
		\begin{center}
			...
			\begin{tabular}{l c c c}
				...
				\midrule
				Strong demand & 4200 & 4160 & 3600 \\
				Moderate demand & 3000 & 3040 & 2700 \\
				Weak demand & 1800 & 1920 & 1800 \\
				\bottomrule
		\end{tabular}
		\end{center}
		...
		\subsection*{C3}
		Payoff equals revenue minus cost, with revenue determined by demand and cost taken from the cost parameters.
		\begin{center}
		...
		\begin{center}
			...
			\begin{tabular}{l c c}
				\toprule
				State of nature & Strategy A cost & Strategy B cost \\
				\midrule
				Strong demand &
				$\begin{array}{l}
					0
