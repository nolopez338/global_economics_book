...
\begin{document}
	...
	\begin{ExamProblems}
		...
		A neighborhood juice bar must choose one of two service formats for the next month: Format A (premium menu)
		or Format B (standard menu). Demand can be high or low. Profits are already estimated in thousands of dollars.
		If demand is high, Format A gives 96 and Format B gives 78. If demand is low, Format A gives 18 and Format B gives 36.
		...
		\item
		\subsection*{Problem description}
		A school cooperative is choosing one of three snack-pack strategies for a festival week: Strategy A (healthy mix),
		Strategy B (balanced mix), or Strategy C (economy mix). Demand can be strong, moderate, or weak.
		Estimated profits (in thousands of dollars) are given directly. Under strong demand: A = 140, B = 122, C = 105.
		Under moderate demand: A = 88, B = 94, C = 76. Under weak demand: A = 12, B = 38, C = 49.
		Construct the payoff table.
		...
		\item
		\subsection*{Problem description}
		A local garment workshop must choose between two production plans for the next season: Plan A (premium shirts)
		or Plan B (basic shirts). Market demand can be very high, high, medium, or low.
		Profit per unit is constant for each plan: Plan A earns \$18 per shirt, Plan B earns \$14 per shirt.
		Expected quantities sold are:
		\begin{itemize}
			\item Very high demand: A sells 9{,}000 shirts, B sells 10{,}200 shirts.
			\item High demand: A sells 7{,}200 shirts, B sells 8{,}300 shirts.
			\item Medium demand: A sells 5{,}000 shirts, B sells 6{,}000 shirts.
			\item Low demand: A sells 2{,}600 shirts, B sells 3{,}400 shirts.
		\end{itemize}
		Construct the payoff table in thousands of dollars.
		...
		\item
		\subsection*{Problem description}
		A community publisher must choose among three distribution models for a new magazine: Model A (city kiosks),
		Model B (school subscriptions), or Model C (mixed channel). Demand can be high or low.
		Each model has a fixed monthly setup component and a variable contribution per copy sold.
		
		Model A: fixed component = \$24{,}000, contribution per copy = \$6.5.
		Model B: fixed component = \$15{,}000, contribution per copy = \$5.8.
		Model C: fixed component = \$19{,}000, contribution per copy = \$6.1.
		
		Expected copies sold:
		...
		\item
		\subsection*{Problem description}
		A student-run printing center must choose between two contract plans for exam-season production: Contract A or Contract B.
		Demand can be strong, normal, or weak. For Contract A, profit values are given directly in thousands of dollars:
		strong = 112, normal = 74, weak = 26.
		For Contract B, profit is computed from a fixed component plus per-booklet margin:
		\[
		\text{Profit}_B = 20{,}000 + (\text{Booklets sold} \times 4.8)
		\]
		Booklets sold for B are 18{,}000 (strong), 12{,}000 (normal), and 7{,}500 (weak).
		Construct the payoff table in thousands of dollars.
		...
		\item
		\subsection*{Problem description}
		A local bus company must choose between Fleet A and Fleet B for a school transport contract.
		Revenue can be high or low, while fuel cost can be low, medium, or high.
		Both revenue and cost values are provided directly in thousands of dollars.
		
		Revenue states:
		Fleet A: high 420, low 290.
		Fleet B: high 450, low 300.
		
		Cost states:
		Fleet A: low 170, medium 205, high 240.
		Fleet B: low 185, medium 220, high 260.
		Construct the payoff table.
		...
		\item
		\subsection*{Problem description}
		A school canteen operator must choose among three lunch service plans: Plan A, Plan B, or Plan C.
		Revenue depends on the number of meals sold and the selling price per meal, while costs are given directly.
		Revenue states are high demand and low demand. Cost states are low cost and high cost.
		
		Quantities and selling prices:
		Plan A sells 14{,}000 meals (high) or 9{,}000 (low), at \$12 per meal.
		Plan B sells 15{,}500 meals (high) or 10{,}500 (low), at \$11.5 per meal.
		Plan C sells 13{,}200 meals (high) or 8{,}800 (low), at \$12.4 per meal.
		
		Costs given directly (thousand USD):
		A: low 102, high 128; B: low 108, high 134; C: low 98, high 124.
		Construct the payoff table in thousands of dollars.
		...
		\item
		\subsection*{Problem description}
		A training center must choose between Program A and Program B.
		Revenue values are given directly for three enrollment states: high, medium, and low.
		Costs depend on participants and are computed from quantity times unit cost.
		
		Revenue (thousand USD):
		Program A: high 360, medium 280, low 210.
		Program B: high 390, medium 300, low 230.
		
		Cost computation data:
		Program A participant counts: low-cost state 1{,}000, high-cost state 1{,}300;
		unit cost per participant = \$120.
		Program B participant counts: low-cost state 1{,}050, high-cost state 1{,}350;
		unit cost per participant = \$125.
		Construct the payoff table in thousands of dollars.
		...
		Both revenue and costs are computed from quantity and unit rates.
		Revenue states are high and medium market demand. Cost states are low, medium, and high component prices.
		Construct the payoff table in thousands of dollars.
		
		Revenue-side data:
		\begin{itemize}
			\item Contract A: quantity high 3{,}200 units, medium 2{,}500 units, selling price \$210 per unit.
			\item Contract B: quantity high 3{,}450 units, medium 2{,}650 units, selling price \$205 per unit.
			\item Contract C: quantity high 3{,}300 units, medium 2{,}600 units, selling price \$208 per unit.
		\end{itemize}
		Cost-side data:
		\begin{itemize}
			\item Contract A cost quantities: low 3{,}100, medium 3{,}100, high 3{,}100 at \$128, \$136, \$145 per unit.
			\item Contract B cost quantities: low 3{,}300, medium 3{,}300, high 3{,}300 at \$124, \$133, \$142 per unit.
			\item Contract C cost quantities: low 3{,}180, medium 3{,}180, high 3{,}180 at \$126, \$135, \$144 per unit.
		\end{itemize}
		...
		Both revenue and costs include fixed and variable components.
		Revenue has three states (high, medium, low demand) and costs have two states (normal and disrupted operations).
		Construct the payoff table in thousands of dollars.
		...
		\end{aligned}
		\]
		Cost-state activity quantities:
