			...
			\begin{minipage}[t]{0.48\linewidth}
				...
				\begin{center}
					\begin{tabular}{l c c}
						...
						Strategy B & 190 & 250 \\
						Strategy C & 210 & 290 \\
						Probabilities of each state & 0.55 & 0.45 \\
						\bottomrule
					\end{tabular}
				\end{center}
			\end{minipage}
			...
			\begin{minipage}[t]{0.48\linewidth}
				...
				\begin{center}
					\begin{tabular}{l c c c}
						...
						Probabilities of each state & 0.30 & 0.50 & 0.20 \\
						\bottomrule
					\end{tabular}
				\end{center}
			\end{minipage}
