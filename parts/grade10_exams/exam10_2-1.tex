...
\begin{document}
	...
	% =========================
	\noindent
	\begin{tabularx}{\textwidth}{|C{3cm}|C{\dimexpr\textwidth-6cm-4\tabcolsep-4\arrayrulewidth\relax}|C{3cm}|}
		\hline
		...
		\CellCenter{%
			...
			\textbf{LEARNING EVIDENCE 2.1}\par
			\textbf{ANALYSIS OF DECISIONS}%
		}
		&
		\CellCenter{%
			\textbf{TERM 2}\par
	...
	\begin{tabular}{|Y|Z|}
		...
		{\small
			...
			C1: Describes the way a problem can be formulated for optimal decision making.\par
	...
	\begin{multicols}{2}
		...
		\SubsectionBox{Decision Analysis}

		\textbf{1. Cafeteria menu plans.}
		...
		\textbf{2. Delivery cooperative fleet strategy.}
		...
		\textbf{3. Community sports center membership model.}
