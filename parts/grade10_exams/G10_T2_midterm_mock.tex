...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{|C{2.8cm}|C{\dimexpr\textwidth-6cm-4\tabcolsep-4\arrayrulewidth\relax}|C{2.8cm}|}
		...
		\CellCenter{%
			...
			\textbf{MIDTERM ANALYSIS OF DECISIONS (MOCK)}\par
			\textbf{PROBLEMS}\par
	...
	\begin{tabular}{|Y|Z|}
		...
		{\footnotesize
			...
			C1--C7: Applies decision criteria and expected value to select alternatives under uncertainty.
		}
		\\
		\hline
	\end{tabular}
	...
	\begin{multicols}{2}
		...
		The mock midterm evaluates decision analysis competencies across criteria C1 to C7 through six problems.
		...
		\vspace{0.25cm}
		\SubsectionBox{2. Logistics Network Decision Under Demand and Cost Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{3. Holiday Inventory Plan Selection Under Expanded Demand Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{4. Routing System Choice Under Fuel and Congestion Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{5. Expected Value Comparison of Production Plans with Three States}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{6. Expected Value Comparison of Zoning Options with Three Alternatives}\vspace{-0.25cm}
