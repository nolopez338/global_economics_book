...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\item
		\subsection*{Problem description}
		A publisher is choosing between two marketing options whose returns depend on whether state $S_1$ or $S_2$ occurs.
		What is the decision maker trying to achieve, what constraints exist in selecting a single option, what uncertainty drives the states
		of nature, why are options A and B the realistic choices, and why do payoffs differ across the states?
		...
		\item
		\subsection*{Problem description}
		A manufacturer must choose among three production plans whose profits depend on whether state $S_1$ or $S_2$ occurs.
		What is the decision maker trying to achieve, what constraints exist in committing to one plan, what uncertainty drives the states of nature,
		why are plans A, B, and C the realistic options, and why do payoffs differ across the states?
		...
		\item
		\subsection*{Problem description}
		A city council is choosing between two zoning options whose returns depend on whether state $S_1$ or $S_2$ occurs.
		What is the decision maker trying to achieve, what constraints exist in selecting a single option, what uncertainty drives the states of nature,
		why are options A and B the realistic choices, and why do payoffs differ across the states?
