	...
	\begin{ExamProblems}
		...
		\begin{center}
			\begin{tabular}{l p{0.74\linewidth}}
				...
				Probabilities & Revenue: 0.55, 0.45; Cost: 0.50, 0.50 \\
				\bottomrule
			\end{tabular}
		\end{center}
		...
		Demand can be very strong, strong, moderate, or weak with probabilities $0.20$, $0.30$, $0.30$, and $0.20$.
		...
		\begin{center}
			...
			\begin{tabular}{l c c c c}
				...
				\midrule
				Very strong demand & 0.20 & 98 & 86 & 78 \\
				Strong demand & 0.30 & 76 & 80 & 70 \\
				Moderate demand & 0.30 & 48 & 58 & 54 \\
				Weak demand & 0.20 & 6 & 32 & 46 \\
				\bottomrule
			\end{tabular}
		\end{center}
		...
		\[
		\begin{aligned}
		\max(\text{Plan A}) &= \max\{98,76,48,6\} = 98,\\
		\max(\text{Plan B}) &= \max\{86,80,58,32\} = 86,\\
		\max(\text{Plan C}) &= \max\{78,70,54,46\} = 78.
		\end{aligned}
		\]
		\[
		...
		\[
		\begin{aligned}
		\min(\text{Plan A}) &= \min\{98,76,48,6\} = 6,\\
		\min(\text{Plan B}) &= \min\{86,80,58,32\} = 32,\\
		\min(\text{Plan C}) &= \min\{78,70,54,46\} = 46.
		\end{aligned}
		\]
		\[
		...
		\[
		\begin{aligned}
			\text{Very strong demand: } &\max\{98, 86, 78\} = 98, \\
			\text{Strong demand: } &\max\{76, 80, 70\} = 80, \\
			\text{Moderate demand: } &\max\{48, 58, 54\} = 58, \\
			\text{Weak demand: } &\max\{6, 32, 46\} = 46.
		\end{aligned}
		\]
		...
		\begin{center}
			\begin{tabular}{l c c c c c}
				\toprule
				Alternative & Very strong $(0.20)$ & Strong $(0.30)$ & Moderate $(0.30)$ & Weak $(0.20)$ & Maximum regret \\
				\midrule
				Plan A & $98-98=0$ & $80-76=4$ & $58-48=10$ & $46-6=40$ & 40 \\
				Plan B & $98-86=12$ & $80-80=0$ & $58-58=0$ & $46-32=14$ & 14 \\
				Plan C & $98-78=20$ & $80-70=10$ & $58-54=4$ & $46-46=0$ & 20 \\
				\bottomrule
			\end{tabular}
		\end{center}
		The minimax regret choice is Plan B because it has the smallest maximum regret $(14)$.
		
		\subsection*{C1}
		\[
		\begin{aligned}
		EV_A &= 0.20(98)+0.30(76)+0.30(48)+0.20(6)=19.6+22.8+14.4+1.2=58,\\
		EV_B &= 0.20(86)+0.30(80)+0.30(58)+0.20(32)=17.2+24+17.4+6.4=65,\\
		EV_C &= 0.20(78)+0.30(70)+0.30(54)+0.20(46)=15.6+21+16.2+9.2=62.
		\end{aligned}
		\]
		The expected value criterion chooses Plan B because $65$ is the largest expected payoff.
		...
		\]
		Option C is optimal when $p \le \frac{5}{13}$, and option A is optimal when $p>\frac{5}{13}$.
