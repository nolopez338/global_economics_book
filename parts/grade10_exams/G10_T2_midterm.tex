...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\vspace{0.25cm}
		\SubsectionBox{1. Bakery Product Bundle Selection Under Multiple Demand Levels}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{3. Shipping Hub Decision Under Demand and Cost Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{4. Community Theater Ticketing Strategy Under Demand Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{5. Holiday Inventory Plan Selection Under Demand Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{6. Routing System Choice Under Fuel and Congestion Uncertainty}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{7. Expected Value Comparison of Marketing Options}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{8. Expected Value Comparison of Production Plans}\vspace{-0.25cm}
		...
		\vspace{0.25cm}
		\SubsectionBox{9. Expected Value Comparison of Zoning Options}\vspace{-0.25cm}
