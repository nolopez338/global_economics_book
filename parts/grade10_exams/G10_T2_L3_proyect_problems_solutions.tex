...
\begin{document}
	...
	\begin{ExamProblems}
		...
		Step 1. Branch outcomes for $A_2$.
		\[
		...
		Step 2. Tree expected value at the chance node.
		\[
		EV_{tree}(A_2)=0.60(130.70)+0.40(100.70)=118.70.
		\]

		Step 3. Decision tree statement.
		\begin{center}
			\begin{tabular}{l}
				\toprule
		...
		\end{itemize}
		Use a decision tree to evaluate this second-stage uncertainty.
		...
		\]
		\[
		EV_{tree}(B_4)=0.70(122.80)+0.30(92.80)=113.80.
		\]
		\begin{center}
			\begin{tabular}{l}
				\toprule
		...
		\]
		\[
		EV_{tree}(C_2)=0.75(124.10)+0.25(92.10)=116.10.
		\]
		\begin{center}
			\begin{tabular}{l}
				\toprule
		...
		\]
		\[
		EV_{tree}(D_4)=0.55(130.90)+0.45(105.90)=119.65.
		\]
		\begin{center}
			\begin{tabular}{l}
				\toprule
