...
\begin{document}
	...
	\begin{itemize}
		...
		\item C1 Describes the way a problem can be formulated for optimal decision making. Expected value and interpret the result.
	\end{itemize}
	A student passes a criterion if it is correctly activated in the solution of the problem.
