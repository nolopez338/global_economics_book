...
\subsection{Solution 1 --- Local Café Investment}\label{subsec:practice-activity-1-solution-1}

\textbf{Structured solution}

\subsubsection{(C2) Interpreting decision alternatives, events, consequences, and states}\label{subsubsec:practice-activity-1-solution-1-c2}
...
\subsubsection{(C3) Building the payoff table}\label{subsubsec:practice-activity-1-solution-1-c3}
...
\subsubsection{(C4) Applying the Maximax criterion}\label{subsubsec:practice-activity-1-solution-1-c4}
...
\subsubsection{(C5) Applying the Maximin criterion}\label{subsubsec:practice-activity-1-solution-1-c5}
...
\subsubsection{(C1) Formulating the decision problem for an optimal choice}\label{subsubsec:practice-activity-1-solution-1-c1}
...
\subsection{Solution 2 --- Green Energy Production Mix}\label{subsec:practice-activity-1-solution-2}

\textbf{Structured solution}

\subsubsection{(C2) Interpreting decision alternatives, events, consequences, and states}\label{subsubsec:practice-activity-1-solution-2-c2}
...
\subsubsection{(C3) Building the payoff table}\label{subsubsec:practice-activity-1-solution-2-c3}
...
\subsubsection{(C4) Applying the Maximax criterion}\label{subsubsec:practice-activity-1-solution-2-c4}
...
\subsubsection{(C5) Applying the Maximin criterion}\label{subsubsec:practice-activity-1-solution-2-c5}
...
\subsubsection{(C1) Formulating the decision problem for an optimal choice}\label{subsubsec:practice-activity-1-solution-2-c1}
...
\subsection{Solution 3 --- Global Shipping Network Design}\label{subsec:practice-activity-1-solution-3}

\textbf{Structured solution}

\subsubsection{(C2) Interpreting decision alternatives, events, consequences, and states}\label{subsubsec:practice-activity-1-solution-3-c2}
...
\subsubsection{(C3) Building the payoff table}\label{subsubsec:practice-activity-1-solution-3-c3}
...
\subsubsection{(C4) Applying the Maximax criterion}\label{subsubsec:practice-activity-1-solution-3-c4}
...
\subsubsection{(C5) Applying the Maximin criterion}\label{subsubsec:practice-activity-1-solution-3-c5}
...
\subsubsection{(C1) Formulating the decision problem for an optimal choice}\label{subsubsec:practice-activity-1-solution-3-c1}
