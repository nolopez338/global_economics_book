...
\begin{document}
	...
	\begin{minipage}{\anchoPag}
		...
		% ----------------------------------------------------------
		\section{Hidden Content Switch}\label{sec:hidden}
		...
		% ----------------------------------------------------------
		\section{Numbering and Table of Contents}\label{sec:numbering}
		...
		% ----------------------------------------------------------
		\section{Images, Figures, and Colors}\label{sec:images}
		...
		% ----------------------------------------------------------
		\section{Page Settings}\label{sec:page}
		...
		% ----------------------------------------------------------
		\section{Font and Code Listings}\label{sec:font}
		...
		% ----------------------------------------------------------
		\section{Hyperlinks and Custom Link Commands}\label{sec:links}
		...
		% ----------------------------------------------------------
		\section{Custom Figure Commands}\label{sec:figcmd}
		...
		% ----------------------------------------------------------
		\section{Other Utility Commands}\label{sec:other}
		...
		% ----------------------------------------------------------
		\section{Navigation and Visual Examples}\label{sec:navigation}
