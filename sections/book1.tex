\chapter{Example 1}\label{example-1}
	...
	\begin{center}
		\begin{tikzpicture}[
			...
			\node[draw, rounded corners, align=left] {Decision node\\ choose strategy}
				child { node[draw, rounded corners, align=left] {Strategy A\\ Innovate}
					child { node[align=left] {High demand\\ 0.30 $\to$ 150k} }
					child { node[align=left] {Moderate demand\\ 0.40 $\to$ 80k} }
					child { node[align=left] {Low demand\\ 0.30 $\to$ -20k} }
				}
				child { node[draw, rounded corners, align=left] {Strategy B\\ Improve}
					child { node[align=left] {High demand\\ 0.30 $\to$ 110k} }
					child { node[align=left] {Moderate demand\\ 0.40 $\to$ 90k} }
					child { node[align=left] {Low demand\\ 0.30 $\to$ 40k} }
				}
				child { node[draw, rounded corners, align=left] {Strategy C\\ License}
					child { node[align=left] {High demand\\ 0.30 $\to$ 70k} }
					child { node[align=left] {Moderate demand\\ 0.40 $\to$ 70k} }
					child { node[align=left] {Low demand\\ 0.30 $\to$ 60k} }
				};
		\end{tikzpicture}
	\end{center}
