\chapter{Grade 11: Confidence \& Interval Estimation}\label{sec:grade11-confidence}

Inferential tools for samples and populations using normal and t-student approaches in Global Economics.

\section{Interval Foundations}\label{sec:interval-foundations}
...
\section{Conceptual Referents}\label{sec:conceptual-referents-intervals}
...
\section{Assessment Criteria}\label{sec:assessment-criteria-intervals}
...
\section{Interval Basics}\label{sec:interval-basics}
...
\section{Support Materials}\label{sec:interval-support-materials}
