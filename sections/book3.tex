...
\begin{table}[h!]
	...
	\begin{tabularx}{\linewidth}{@{}l p{5cm} c *{4}{c} @{}}
		\toprule
		\multirow{2}{*}{State}
		& \multirow{2}{3cm}{Combined scenario}
		& \multirow{2}{*}{Probability}
		& A: Premium & B: Premium & C: Volume & D: Volume \\
...
\begin{center}
	...
	\resizebox{1.3\textwidth}{!}{%
		\begin{tikzpicture}[
			...
			every node/.style={align=left,font=\scriptsize},
			decision/.style={draw,rounded corners,inner sep=3pt,text width=42mm},
			chance/.style={draw,circle,inner sep=1.2pt},
			leaf/.style={inner sep=1pt,text width=58mm}
			]
			
			\node[decision]{Decision node\\Choose combined decision}
			child { node[decision]{Decision A\\Premium revenue\\Stable costs}
				child { node[leaf]{S1 high demand, favourable costs\\$p=0.18$\\profit $=4000$} }
				child { node[leaf]{S2 high demand, unfavourable costs\\$p=0.12$\\profit $=3400$} }
				child { node[leaf]{S3 moderate demand, favourable costs\\$p=0.27$\\profit $=2500$} }
				child { node[leaf]{S4 moderate demand, unfavourable costs\\$p=0.18$\\profit $=1900$} }
				child { node[leaf]{S5 weak demand, favourable costs\\$p=0.15$\\profit $=1200$} }
				child { node[leaf]{S6 weak demand, unfavourable costs\\$p=0.10$\\profit $=600$} }
			}
			child { node[decision]{Decision B\\Premium revenue\\Flexible costs}
				child { node[leaf]{S1\\$p=0.18$\\profit $=4500$} }
				child { node[leaf]{S2\\$p=0.12$\\profit $=2600$} }
				child { node[leaf]{S3\\$p=0.27$\\profit $=3000$} }
				child { node[leaf]{S4\\$p=0.18$\\profit $=1100$} }
				child { node[leaf]{S5\\$p=0.15$\\profit $=1700$} }
				child { node[leaf]{S6\\$p=0.10$\\profit $=-200$} }
			}
			child { node[decision]{Decision C\\Volume revenue\\Stable costs}
				child { node[leaf]{S1\\$p=0.18$\\profit $=3500$} }
				child { node[leaf]{S2\\$p=0.12$\\profit $=2900$} }
				child { node[leaf]{S3\\$p=0.27$\\profit $=2300$} }
				child { node[leaf]{S4\\$p=0.18$\\profit $=1700$} }
				child { node[leaf]{S5\\$p=0.15$\\profit $=1800$} }
				child { node[leaf]{S6\\$p=0.10$\\profit $=1200$} }
			}
			child { node[decision]{Decision D\\Volume revenue\\Flexible costs}
				child { node[leaf]{S1\\$p=0.18$\\profit $=4000$} }
				child { node[leaf]{S2\\$p=0.12$\\profit $=2100$} }
				child { node[leaf]{S3\\$p=0.27$\\profit $=2800$} }
				child { node[leaf]{S4\\$p=0.18$\\profit $=900$} }
				child { node[leaf]{S5\\$p=0.15$\\profit $=2300$} }
				child { node[leaf]{S6\\$p=0.10$\\profit $=400$} }
			};
